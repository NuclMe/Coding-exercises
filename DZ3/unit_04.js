...
function f4() {
  if (checkbox.checked) {
    divOut4.innerHTML = true;
  } else {
    divOut4.innerHTML = false;
  }
}
...
function f5() {
  if (checkbox2.checked) {
    divOut5.innerHTML = checkbox2.value;
  } else {
    divOut5.innerHTML = false;
  }
}
...
let checkbox3 = document.querySelector('.i-6');

function f6() {
  divOut6.innerHTML = checkbox3.value;
}
...
let input1 = document.querySelector('.i-7');

function f7() {
  if (input1.value.length >= 6) {
    divOut72.innerHTML = 1;
  } else {
    divOut72.innerHTML = 0;
  }
}
...
function f8() {
  divOut8.innerHTML += `<div class='js2'>new div </div>`;
}
...
function f9() {
  if (radioButton.checked) {
    divOut9.innerHTML = 'radiobutton';
  } else {
    divOut9.innerHTML = false;
  }
}
...
let colorPicker = document.querySelector('.i-10');
let divOut10 = document.querySelector('.out-10');

function f10() {
  divOut10.style.backgroundColor = colorPicker.value;
}
...
let colorPicker2 = document.querySelector('.i-111');
let colorPicker3 = document.querySelector('.i-112');

function f11() {
  colorPicker3.value = colorPicker2.value;
}
...
let dateInput = document.querySelector('.i-12');
let divOut12 = document.querySelector('.out-12');

function f12() {
  divOut12.innerHTML = dateInput.value;
}
...
let rangeInput = document.querySelector('.i-13');
let divOut13 = document.querySelector('.out-13');

function f13() {
  divOut13.innerHTML = rangeInput.value;
}
...
function f14() {
  divOut14.innerHTML = textarea.value;
}
...
let textInput = document.querySelector('.i-15');
let textarea2 = document.querySelector('.t-15');
let divOut15 = document.querySelector('.out-15');

function f15() {
  textarea2.value = textInput.value;
  divOut15.innerHTML = textarea2.value;
}
...
let divOut16 = document.querySelector('.out-16');

function f16() {
  divOut16.innerHTML = select.value;
...
let select2 = document.querySelector('.s-17');
let divOut17 = document.querySelector('.out-17');

function f17() {
  divOut17.innerHTML = select2.value;
}
...
let select3 = document.querySelector('.s-18');
let input = document.querySelector('.i-18');

function f18() {
  input.value = select3.value;
}
...
let input2 = document.querySelector('.i-19');
let divOut19 = document.querySelector('.out-19');

function f19() {
  input2.value = divOut19.innerHTML;
}
...
let select4 = document.querySelector('.s-201');
let select5 = document.querySelector('.s-202');

function f20() {
  select5.value = select4.value;
}
